...
3. Добавлено уведомление о наличии аккаунта для подписки в папке «subscription», если аккаунта нет, то TelegramMaster-PRO
...
🔄 Обновление TelegramMaster-PRO 🚀<br>
📦 Версия: 2.7.17<br>
📅 Дата релиза: 25.11.2025<br>

✨ Основные изменения и улучшения в проекте:

1. Удалено излишнее логирование, чтобы пользователя не перегружать информацией о работе программы, за исключением записи
   ошибок.
2. Функции «Рассылка сообщений в личку» и «Рассылка сообщений по чатам» вынесены на главное меню в виде отдельных кнопок для быстрого доступа.
...
6. Добавлена проверка на дублирующиеся записи при использовании функции «📑 Формирование списка чатов / каналов» при записи в чистую базу данных.
7. В функции «🔍 Парсинг одной группы / групп» добавлены CupertinoSwitch-переключатели для удобного выбора режима: парсинг администраторов, парсинг групп, на которые подписан аккаунт, или парсинг участников по ранее сформированному списку.
...
19. В меню «Инвайтинг» добавлен прямой ввод ссылок для приглашений, что упрощает процесс и улучшает пользовательский опыт.
20. В меню «Подписка / Отписка» добавлен ввод ссылок на группы и каналы. Ссылки сохраняются в базу данных в таблицу writing_group_links для последующей обработки.
21. Добавлена обработка ошибки при подписке на группы, каналы, если session-файл аккаунта поврежден.
22. Добавлен ввод времени задержки между подписками на группы и каналы для снижения риска блокировки.
23. В меню «Инвайтинг» добавлен ввод времени запуска инвайтинга в определённое время для точного планирования задач.
24. Из настроек программы удалён параметр ввода времени запуска инвайтинга в определённое время, так как он перенесён в соответствующее меню для улучшения интерфейса.
25. В меню «Инвайтинг» добавлен ввод лимитов на аккаунт, что позволяет гибко настраивать параметры без перехода в настройки программы.
26. Добавлен ввод времени задержки (сна) между приглашениями в инвайтинге для соблюдения лимитов Telegram.
27. В меню «Инвайтинг» добавлены CupertinoSwitch-переключатели для простого переключения между режимами: инвайтинг 1 раз в час, в определённое время или ежедневно.
28. Изменено главное меню программы.
29. Отладка внешнего вида в меню «Инвайтинг».
30. Изменен внешний вид выбора реакции в настройках программы.
31. Из настроек программы удалены устаревшие параметры: Запись времени, Запись ссылки, Лимиты на аккаунт, Лимиты на сообщения, Формирование списка username, Время между подпиской, Запись времени между сообщениями, Время между инвайтингом, Рассылка сообщений, Формирование списка чатов / каналов, Очистка сформированного списка чатов.
32. Изменение внешнего вида функции "💬 Рассылка сообщений по чатам".
33. Изменение внешнего вида функции "️‍🗨️ Накручиваем просмотры постов".
34. Отладка функции "Накрутка просмотров постов"
35. Изменение внешнего вида функции "📇 Работа с контактами"
36. Изменение внешнего вида функции "✏️ Редактирование_BIO"
37. Изменение внешнего вида функции "❤️ Работа с реакциями"
38. В функции «️‍🗨️ Накручиваем просмотры постов» добавлено отображение времени начала и завершения накрутки, а также ввод количества просмотров. При наличии 10 аккаунтов пользователь может указать до 10 просмотров.
39. Изменен внешний вид меню "✏️ Редактирование_BIO". Работа с BIO с одного окна программы.
40. Изменен внешний вид меню "📇 Работа с контактами".
41. Во время парсинга контактов аккаунтов в функции "📇 Работа с контактами", добавлено отображение начало старта и
    окончание процесса.
42. Формирование списка контактов, в едином меню "📇 Работа с контактами".
43. Формирование главного меню "Проверка аккаунтов".
44. В инвайтинге лимит прописывается только в окне инвайтинга. Запись в config-файл была убрана по причине облегчения
    пользовательского опыта.
45. Ускорен запуск программы в 2 раза.
46. Переписана документация для инвайтинга
47. Переписана документация для парсинга
48. Сформировано новое меню, для функции "❤️ Работа с реакциями"
49. Добавлен пользовательский ввод сообщения для автоответчика.
50. Добавлен выбор аккаунта для рассылки сообщений и работы автоответчика из выпадающего списка.
51. В функции "Создание групп (чатов)", добавлен выбор аккаунта из выпадающего списка.
