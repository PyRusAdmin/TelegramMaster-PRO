...
24. Из настроек программы был удален пункт ввода времени для запуска инвайтинга в определенное время для улучшения
    пользовательского опыта.
25. В меню инвайтинг добавлен ввод лимитов на аккаунт для удобства пользователя, чтобы не вводить в настройках
    программы.
26. Добавлен ввод сна между приглашениями в инвайтинге.
27. В меню инвайтинга добавлены CupertinoSwitch-переключатели для облегченного выбора нужной функции.
...
31. Из настроек были удалены: Запись времени, Запись ссылки, Лимиты на аккаунт, Лимиты на сообщения, Формирование списка
    username, Время между подпиской, Запись времени между сообщениями, Время между инвайтингом, рассылка сообщений,
    Формирование списка чатов / каналов, Очистка сформированного списка чатов
...
38. В функции "️‍🗨️ Накручиваем просмотры постов" добавлено: отображение времени старта и окончания накрутки. Добавлен
    ввод количества просмотров. Если аккаунтов, например 10, то пользователь может выбрать до 10 просмотров.
...
50. Добавлен выбор аккаунта, для рассылки сообщения и автоответчика.
